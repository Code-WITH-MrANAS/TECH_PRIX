...
const serviceLinks = [
  ...
  { label: '3D Web Experiences', path: '/services/3d-web-experiences' },
];
...
const socials = [
  ...
  { Icon: InstagramIcon, href: 'https://www.instagram.com/techprix.official', label: 'Instagram' },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-text-light text-xs mb-3">Founded by Anas Ali</p>
            <a
