          ...
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center gap-8">
              {navLinks.map((link) => (
                ...
                >
                  {link.name}
                  <span className={`absolute -bottom-0.5 left-0 h-0.5 bg-gradient-to-r from-primary to-accent rounded-full transition-all duration-300 ${
                  ...
                  >
                    <Link
                      ...
                      className={`px-4 py-3 rounded-xl font-medium transition-all duration-200 block ${
                        isActive(link.path)
                          ? 'text-primary bg-indigo-50 dark:bg-indigo-950/30'
                          : 'text-text-secondary hover:text-primary hover:bg-indigo-50 dark:hover:bg-indigo-950/30'
                      }`}
                    >
                      {link.name}
                    </Link>
