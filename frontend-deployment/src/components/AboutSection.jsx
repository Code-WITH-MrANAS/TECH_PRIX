      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-20">
          ...
          <div>
            ...
            >
              {['Clean Code', 'Pixel Perfect', 'On-Time Delivery', 'Transparent Pricing'].map((v) => (
          ...
          >
            ...
            {/* Floating badge 1 */}
            <div className="absolute -top-5 -left-6 glass rounded-2xl px-4 py-3 shadow-lg border border-white/80 float-slow">
              <p className="text-xs text-text-muted font-medium">Average rating</p>
              <p className="text-xl font-black text-text-main">★ 5.0</p>
            </div>

            {/* Floating badge 2 */}
            <div className="absolute -bottom-5 -right-6 glass rounded-2xl px-4 py-3 shadow-lg border border-white/80 float-medium">
