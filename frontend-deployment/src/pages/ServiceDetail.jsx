...
const ServiceDetail = () => {
  ...
  const serviceSchema = {
    ...
    url: `https://www.techprix.online/services/${serviceId}`,
    provider: {
      '@type': 'Organization',
      name: 'TechPrix',
      url: 'https://www.techprix.online',
    },
  };
  ...
  return (
    <div className="min-h-screen bg-bg-main">
      ...
      />
      {/* Hero Section */}
      <section className={`relative pt-32 pb-20 bg-gradient-to-br ${dark ? service.darkBg : service.lightBg} overflow-hidden`}>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <Breadcrumbs items={[
            ...
            { label: service.title, path: `/services/${serviceId}` },
          ]} />
